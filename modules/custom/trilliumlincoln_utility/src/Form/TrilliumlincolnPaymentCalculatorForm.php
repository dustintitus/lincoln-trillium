  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (($hide_lease_section && $hide_finance_section) || $price == 0) {
      ...
      $form['payment']['pmt_description'] = [
        '#markup' => '<p>' . $this->t('*PMT is biweekly, plus HST & Licensing. Lease parts are based on 25,000km/yr with a due on delivery of any cost down, 1st mth part, applicable HST, licensing & registration. Pricing is subject to incentive eligibility.') . '</p>'
      ];
    }
